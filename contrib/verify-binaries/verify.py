#!/usr/bin/env python3
# Copyright (c) 2020-2021 The biblio Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Script for verifying biblio Core release binaries.
...
def verify_shasums_signature(
   ...
   ReturnCode, list[SigData], list[SigData], list[SigData], list[SigData]
    ...
    # which pubkeys within the biblio community do we trust for the purposes of
    # binary verification?
    trusted_keys = set()
