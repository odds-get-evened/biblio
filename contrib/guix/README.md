# Bootstrappable biblio Core Builds

This directory contains the files necessary to perform bootstrappable biblio
Core builds.
...
To build biblio Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      biblio Core version being built.
