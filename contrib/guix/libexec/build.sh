...
(
    ...
    # Setup the directory where our biblio Core build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built biblio Core to $INSTALLPATH
    case "$HOST" in
        *darwin*)
    ...
    case "$HOST" in
        *darwin*)
            ...
            mv build/dist/biblio-Core.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
