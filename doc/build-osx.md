...
These tools must be installed in order to build biblio Core from source.
...
### 4. Clone biblio repository

`git` should already be installed by default on your system.
Now that all the required dependencies are installed, let's clone the biblio Core repository to a directory.
...
You can [deploy](#3-deploy-optional) a `.zip` containing the biblio Core application.
...
Run the following in your terminal to compile biblio Core:
...
biblio Core should now be available at `./build/src/bitcoind`.
...
``` bash
/Users/${USER}/Library/Application Support/biblio/
```

Before running, you may create an empty configuration file:

```shell
mkdir -p "/Users/${USER}/Library/Application Support/biblio"

touch "/Users/${USER}/Library/Application Support/biblio/bitcoin.conf"

chmod 600 "/Users/${USER}/Library/Application Support/biblio/bitcoin.conf"
```

You can monitor the download process by looking at the debug.log file:

```shell
tail -f $HOME/Library/Application\ Support/biblio/debug.log
```
