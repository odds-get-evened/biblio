# Fuzzing biblio Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing biblio Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
## Overview of biblio Core fuzzing

[Google](https://github.com/google/fuzzing/) has a good overview of fuzzing in general, with contributions from key architects of some of the most-used fuzzers. [This paper](https://agroce.github.io/bitcoin_report.pdf) includes an external overview of the status of biblio Core fuzzing, as of summer 2021.  [John Regehr](https://blog.regehr.org/archives/1687) provides good advice on writing code that assists fuzzers in finding bugs, which is useful for developers to keep in mind.
...
Every single pull request submitted against the biblio Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make biblio Core more robust.
...
# Fuzzing biblio Core using afl++

## Quickstart guide

To quickly get started fuzzing biblio Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing biblio Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing biblio Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
biblio Core participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/bitcoin-core)
...
biblio Core follows its [security disclosure policy](https://bitcoincore.org/en/security-advisories/),
