...
Below are some notes on how to build biblio Core for Windows.

The options known to work for building biblio Core on Windows are:
...
Note that for WSL the biblio Core source path MUST be somewhere in the default mount file system, for
