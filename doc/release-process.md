...
Checkout the biblio Core version you'd like to build:
...
- Announce the release:
  ...
  - biblio Core announcements list https://bitcoincore.org/en/list/announcements/join/

  - biblio Core Twitter https://twitter.com/bitcoincoreorg
