...
The biblio Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in biblio Core requires the ZeroMQ API >= 4.0.0
...
using. bibliod appends an up-counting sequence number to each
