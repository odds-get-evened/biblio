...
biblio Core version 25.0 is now available from:
...
dbcache, biblio Core will now return an error at startup. (#25574)
...
before biblio Core has begun its shutdown sequence. (#23395)
