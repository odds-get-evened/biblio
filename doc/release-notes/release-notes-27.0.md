biblio Core version 27.0 is now available from:
...
- A C++20 capable compiler is now required to build biblio Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of biblio Core would
