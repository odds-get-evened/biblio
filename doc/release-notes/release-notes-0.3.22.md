Download URL: https://sourceforge.net/projects/bitcoin/files/biblio/bitcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 LEX fee schedule (users still pay 0.01 LEX per kb, until next version)
