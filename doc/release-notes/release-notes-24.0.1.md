...
biblio Core version 24.0.1 is now available from:
...
This version of biblio Core adds a new `mempoolfullrbf` configuration
...
Some biblio services today expect that the first version of an
...
The biblio Protocol does not, and cannot, provide any assurance that
...
fees, was realized in [biblio Core 0.12.0][] (February 2016) with the
...
default for years, and several contributors to biblio Core are
...
[biblio Core 0.12.0]: https://bitcoincore.org/en/releases/0.12.0/#opt-in-replace-by-fee-transactions
...
- To help prevent fingerprinting transactions created by the biblio Core wallet, change output
