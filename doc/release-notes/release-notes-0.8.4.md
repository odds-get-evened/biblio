biblio-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/biblio/bitcoin-0.8.4/
...
code, causing the biblio-Qt or bitcoind process to crash.
...
their own version of biblio against Boost versions 1.50-1.52.
