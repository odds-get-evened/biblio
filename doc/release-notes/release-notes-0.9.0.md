biblio Core version 0.9.0 is now available from:
...
earlier versions of biblio, then run the installer (on Windows) or just copy
over /Applications/biblio-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the biblio
...
Rebranding to biblio Core
---------------------------

To reduce confusion between biblio-the-network and biblio-the-software we
have renamed the reference client to biblio Core.
...
Using the standard "./autogen.sh; ./configure; make" to build biblio-Qt and
...
0.1mLEX per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mLEX per kilobyte
