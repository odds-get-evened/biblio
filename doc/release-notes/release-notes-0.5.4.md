biblio version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/biblio/bitcoin-0.5.4/
...
Fix biblio-Qt notifications under Growl 1.3.
Increase required age of biblio-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxbiblio properly when installing biblio-Qt over it. (Windows)
