# PSBT Howto for biblio Core

Since biblio Core 0.17, an RPC interface exists for Partially Signed biblio
...
PSBT is an interchange format for biblio transactions that are not fully signed
...
#### Multisig with multiple biblio Core instances
...
biblio Core. We assume their wallets only contain the multisig funds. In case
...
Later, when *V* LEX has been received on *Amulti*, and Bob and Carol want to
