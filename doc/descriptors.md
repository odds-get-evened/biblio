# Support for Output Descriptors in biblio Core

Since biblio Core v0.17, there is support for Output Descriptors. This is a
...
on biblio's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a biblio Core descriptor wallet to serve as your
...
existing biblio Core wallets, a convenience function `combo` is
...
All RPCs in biblio Core will include the checksum in their output. Only
