...
**When configuring biblio Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring biblio Core:
...
variables will be set when generating the biblio Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
