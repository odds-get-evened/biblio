...
class TxnMallTest(biblioTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 LEX:
        ...
        # First: use raw transaction API to send 1240 LEX to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 LEX coin each
        ...
        # Node0's balance should be starting balance, plus 50LEX for another
        ...
        # Node0's total balance should be starting balance, plus 100LEX for
