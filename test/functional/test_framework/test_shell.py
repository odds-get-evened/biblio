#!/usr/bin/env python3
# Copyright (c) 2019-2022 The biblio Core developers
...
class TestShell:
    """Wrapper Class for biblioTestFramework.

    The TestShell class extends the biblioTestFramework
    ...
    class __TestShell(biblioTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by biblioTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # biblioTestFramework instances are supposed to be constructed with the path
