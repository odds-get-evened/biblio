...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the biblioTestFramework
    pass


class ExampleTest(biblioTestFramework):
    # Each functional test is a subclass of the biblioTestFramework class.
    ...
    def custom_method(self):
        ...
        biblioTestFramework class so other tests can use it."""
