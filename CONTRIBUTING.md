Contributing to biblio Core
============================

The biblio Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "biblio Core
...
Before you start contributing, familiarize yourself with the biblio Core build
system and tests. Refer to the documentation in the repository on how to build
biblio Core and how to run the unit tests, functional tests, and fuzz tests.
...
[biblio Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about biblio Core development happens on IRC, in the
...
fork of biblio Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the biblio Core project (and related
projects such as libsecp256k1), and is not to be confused with overall biblio
Network Protocol consensus changes.

Whether a pull request is merged into biblio Core rests with the project merge
maintainers.
...
Patches that change biblio consensus rules are considerably more involved than
...
Where a patch set proposes to change the biblio consensus, it must have been
