    ...
    return
         {
             ...
             {RPCResult::Type::STR, "address", /*optional=*/true, "The biblio address (only if a well-defined address exists)"},
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{
        "decodepsbt",
        "Return a JSON object representing the serialized, base64-encoded partially signed biblio transaction.",
                {
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed biblio transactions into one transaction.\n"
