...
const std::string CURRENCY_UNIT = "LEX"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    LEX_KVB,      //!< Use LEX/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::LEX_KVB) const;
