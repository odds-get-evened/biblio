...
/** Interface from Qt to configuration data structure for biblio client.
...
public:
    ...
    biblioUnit getDisplayUnit() const { return m_display_bitcoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSLEXontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    biblioUnit m_display_bitcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(biblioUnit unit);
