...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, biblioUnits::SeparatorStyle separators=biblioUnits::SeparatorStyle::STANDARD) const;
