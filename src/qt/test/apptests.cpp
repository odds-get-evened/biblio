...
//! Entry point for biblioApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &biblioApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for biblioGUI tests.
void AppTests::guiTests(biblioGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &biblioGUI::consoleShown, this, &AppTests::consoleTests);
