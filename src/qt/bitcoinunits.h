...
/** biblio unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class biblioUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit biblioUnits(QObject *parent);
...
typedef biblioUnits::Unit biblioUnit;
