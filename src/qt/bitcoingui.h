...
/**
  biblio GUI main class. This class represents the main window of the biblio UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class biblioGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit biblioGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~biblioGUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, biblioUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed biblio Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(biblioUnit newUnits);
