...
class biblioGuiInit : public interfaces::Init
{
public:
    biblioGuiInit(const char* arg0) : m_ipc(interfaces::MakeIpc(EXE_NAME, arg0, *this))
    {
        InitContext(m_node);
        m_node.init = this;
    }
...
{
    return std::make_unique<init::biblioGuiInit>(argc > 0 ? argv[0] : "");
}
} // namespace interfaces
