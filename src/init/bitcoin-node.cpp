...
class biblioNodeInit : public interfaces::Init
{
public:
    biblioNodeInit(node::NodeContext& node, const char* arg0)
        : m_node(node),
...
{
    auto init = std::make_unique<init::biblioNodeInit>(node, argc > 0 ? argv[0] : "");
